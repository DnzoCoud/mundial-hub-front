...
export default function AppSidebar({ setShowPreferences, handleLogout }: AppSidebarProps) {
  return (
    <Sidebar className="w-80 border-r border-yellow-600/30 bg-[#0c1a2a] flex flex-col h-full shadow-2xl shadow-black/50">
      <div className="flex h-48 items-center justify-center border-b border-yellow-600/30">
        <img src={logoImg} alt="Mundial 2026" className="h-60 w-auto drop-shadow-xl" />
      </div>
